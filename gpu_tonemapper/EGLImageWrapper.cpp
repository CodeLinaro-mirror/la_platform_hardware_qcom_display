...
//-----------------------------------------------------------------------------
static EGLImageBuffer *L_wrap(const SnapHandle *snap_hnd,
                              std::shared_ptr<ISnapMapper> snapmapper)
//-----------------------------------------------------------------------------
{
  ...
  if (snapmapper->GetMetadata(*snap_hnd, PIXEL_FORMAT_REQUESTED, &format)
                  != SnapError::NONE) {
  ...
  android::sp<android::GraphicBuffer> graphicBuffer =
    new android::GraphicBuffer(handle, android::GraphicBuffer::CLONE_HANDLE,
                               width, height, format, 1, //Layer Count
