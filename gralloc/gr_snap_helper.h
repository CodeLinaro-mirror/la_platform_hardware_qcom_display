 ...
 private:
  ...
  std::unordered_map<vendor_qti_hardware_display_common_MetadataType, MetadataHelper>
      metadata_conversion_helper_function_map = {
          ...
          {MD_PP_PARAM_INTERLACED, &GrallocSnapHelper::PPParamInterlacedHelper},
          ...
          {MD_MAP_SECURE_BUFFER, &GrallocSnapHelper::MapSecureBufferHelper},
          {MD_LINEAR_FORMAT, &GrallocSnapHelper::LinearFormatHelper},
...
=======
  ...
  bool enable_logs_ = false;
>>>>>>> e2dacf9c5 (gralloc: Enable debug logging through property)
  ...
  std::unordered_map<vendor_qti_hardware_display_common_MetadataType, MetadataHelper>
      metadata_conversion_helper_function_map = {
          ...
          {MD_PP_PARAM_INTERLACED, &GrallocSnapHelperLegacy::PPParamInterlacedHelper},
          ...
          {MD_MAP_SECURE_BUFFER, &GrallocSnapHelperLegacy::MapSecureBufferHelper},
          {MD_LINEAR_FORMAT, &GrallocSnapHelperLegacy::LinearFormatHelper},
